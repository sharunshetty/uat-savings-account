...
function check_countrywise_ip() {
  ...
  //  http://192.168.0.56:9501/ - prod ip server
	$ip_req =  "http://172.31.0.103:8090/GetCityDetails?key=7c756203dbb38590a66e01a5a3e1ad96&fqcn=". $serv_ip;
   
    //$outputdata = file_get_contents('http://172.31.0.103:8090/GetCityDetails?key=7c756203dbb38590a66e01a5a3e1ad96&fqcn='. $serv_ip);
